                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="activity_type" name="activity_type">
                                        ...
                                        <option value="login"
                                            {{ request('activity_type') == 'login' ? 'selected' : '' }}>Login</option>
                                        <option value="logout"
                                            {{ request('activity_type') == 'logout' ? 'selected' : '' }}>Logout</option>
                                        <option value="register"
                                            {{ request('activity_type') == 'register' ? 'selected' : '' }}>Register
                                        </option>
                                        <option value="user_created"
                                            {{ request('activity_type') == 'user_created' ? 'selected' : '' }}>User
                                            Created</option>
                                        <option value="user_updated"
                                            {{ request('activity_type') == 'user_updated' ? 'selected' : '' }}>User
                                            Updated</option>
                                        <option value="user_deleted"
                                            {{ request('activity_type') == 'user_deleted' ? 'selected' : '' }}>User
                                            Deleted</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-{{ $log->activity_type == 'login' ? 'success' : ($log->activity_type == 'logout' ? 'warning' : ($log->activity_type == 'register' ? 'info' : ($log->activity_type == 'user_deleted' ? 'danger' : 'primary'))) }}">
